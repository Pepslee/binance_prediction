...
from binance_prediction.losses import get_loss
...
#
#
# print(next(train_data_set)[0])
# print(next(train_data_set)[0])
# print(next(train_data_set)[0])
model = build_model((X_SIZE, new_df.shape[1]), get_loss())
print(model.summary())
#
model.fit(train_data_set, steps_per_epoch=len(train_data_set), epochs=5000,
          ...
          callbacks=get_callbacks(test_data_set)
          )
#
